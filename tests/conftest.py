...
def test_config() -> dict:
    ...
    """
    return {
        "general": {"app_name": "VioraTalk Test", "version": "0.0.1", "language": "ja"},
        "stt": {"engine": "mock", "model_size": "base"},
        "llm": {"engine": "mock", "timeout": 30},
        "tts": {"engine": "mock", "speaker_id": 1},
    }
...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "manual: 手動確認が必要なテスト")
    config.addinivalue_line("markers", "phase(n): 特定のPhaseでのテスト")
