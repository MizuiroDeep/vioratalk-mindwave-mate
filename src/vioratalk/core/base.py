...
class VioraTalkComponent(ABC):
    ...
    async def safe_initialize(self) -> None:
        ...
        self._logger.info(
            f"{self.__class__.__name__} 初期化開始", extra={"component": self.__class__.__name__}
        )
        ...
        try:
            ...
            self._logger.error(
                ...
                extra={"component": self.__class__.__name__, "error_type": type(e).__name__},
                exc_info=True,
            )
            raise
    ...
    async def safe_cleanup(self) -> None:
        ...
        if self._state == ComponentState.TERMINATED:
            self._logger.debug(
                f"{self.__class__.__name__} 既に終了済み", extra={"component": self.__class__.__name__}
            )
            return

        self._state = ComponentState.SHUTDOWN
        self._logger.info(
            f"{self.__class__.__name__} クリーンアップ開始", extra={"component": self.__class__.__name__}
        )
        ...
        try:
            ...
            self._logger.info(
                f"{self.__class__.__name__} クリーンアップ完了", extra={"component": self.__class__.__name__}
            )
            ...
            self._logger.debug(
                f"{self.__class__.__name__} 終了", extra={"component": self.__class__.__name__}
            )
